...
const projects: Project[] = [
  {
    id: "machinalytics",
    title: "Machinalytics",
    description: "Machinalytics is an all-in-one platform for exploring, visualizing, and collaborating on machine learning projects. It combines data visualization, model analysis, and real-time communication into a single, seamless app.",
    image: machinalytics,
  ...
  },
  {
    ...
    description: "Project Severance was born from our fascination with psychological horror and the thrill of being hunted. As two high-school students, we wanted to challenge ourselves to create something way bigger than expected.",
  ...
  },
  {
    id: "baguettes",
    title: "Baguettes",
    description: "This mod adds Baguettes to Minecraft! Crafted from 3 bread, this item fully restores hunger and saturation.",
    image: baguettes,
    tags: ["Java", "Gradle"],
    category: "featured",
    links: {
  ...
  },
  {
    id: "riveote",
    title: "Riveote",
    description: "Riveote is a minimalist quote generator designed to inspire creativity and focus. Featuring a clean UI, it delivers motivational quotes you can instantly copy.",
    image: riveote,
  ...
  },
  {
    ...
    description: "Colorful Lamp adds craftable redstone lamps in every color, perfect for decorating and customizing your builds.",
    image: colorfullamp,
    tags: ["Java", "Gradle"],
  ...
  },
  {
    id: "effective",
    title: "Effective",
    description: "The mod adds various effects like water splashes, waterfall clouds, fireflies, improved visual effects, screen shake and many more.",
    image: effective,
    tags: ["Java", "Gradle"],
    category: "contributed",
    links: {
...
function Showcase() {
  ...
  const renderProjectCard = (project: Project, isContributed = false) => {
    const CardClass = isContributed ? "contributed-card" : "project-card"
    const ImageClass = isContributed ? "contributed-image" : "project-image"
    const ContentClass = isContributed ? "contributed-content" : "project-content"
    const TitleTag = isContributed ? "h4" : "h3"
  ...
  return (
    <section className="section showcase">
      ...
      {categoryFilter === "all" ? (
        <>
          {featuredProjects.length > 0 && (
            <div className="showcase-section">
              ...
              <div className="project-grid">
                {featuredProjects.map(p => renderProjectCard(p))}
              </div>
            </div>
          )}
          ...
          {collaborativeProjects.length > 0 && (
            <div className="showcase-section">
              ...
              <div className="project-grid">
                {collaborativeProjects.map(p => renderProjectCard(p))}
              </div>
            </div>
          )}
          ...
          {contributedProjects.length > 0 && (
            <div className="showcase-section">
              ...
              <div className="contributed-grid">
                {contributedProjects.map(p => renderProjectCard(p, true))}
              </div>
            </div>
          )}
        </>
        ...
        <div className="showcase-section">
          <div className={categoryFilter === "contributed" ? "contributed-grid" : "project-grid"}>
            {filteredProjects.map(p => renderProjectCard(p, categoryFilter === "contributed"))}
          </div>
        </div>
      )}
